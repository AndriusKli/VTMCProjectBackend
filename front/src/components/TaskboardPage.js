...
function TaskboardPage() {
    ...
    const notStartedTasks = project !== undefined ? selectTasks(project.tasks, { "searchBy": '', "filterStatusBy": "NOT_STARTED" }) : null;
    const inProgressTasks = project !== undefined ? selectTasks(project.tasks, { "searchBy": '', "filterStatusBy": "IN_PROGRESS" }) : null;
    const completeCanceledTasks = project !== undefined ? selectTasks(project.tasks, { "searchBy": '', "filterStatusBy": "COMPLETE" }).concat(selectTasks(project.tasks, { "searchBy": '', "filterStatusBy": "CANCELED" })) : null;
