...
function TaskEditAndCreateForm() {
    ...
    const task = project !== undefined ? project.tasks.find(({ taskId }) => taskId === parseInt(params.taskid)) : null;
    ...
    return (
        project ?
            ...
            :
            <div className="text-center"> Project not found, please go back. </div>
    )
}
